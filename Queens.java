...
/*TO RUN IN COMMAND PROMPT: java Queens.java PrimitiveLogic 6 */

/**
 * The main class that parses command line parameters and initializes the
 * n-queens problem.
 *
 * @author Mai Ajspur
 * @version 16.2.2018
...
public class Queens {
	 ...
	 * Standard values for size (length of square board) is 8. Should be greater
	 * than 4
	 */
	public static void main(String[] arg) {
		String[] args = { "QueensLogic02" };
	 ...
	 *                 class implementing IQueensLogic
	 */
