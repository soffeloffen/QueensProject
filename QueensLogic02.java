...
public class QueensLogic02 implements IQueensLogic {
	...
	public BDDFactory fact;;

	private BDD game_rules;
	private BDD restrictions;
	...
	public void initializeBoard(int size) {
		...
		this.fact = JFactory.init(nodes, cache);
		this.game_rules = fact.one();
		this.restrictions = fact.one();
		// setGameRules();
	}
	 ...
	 * }
	 * 
	 * // get all the positions that is mutually exclusive with for position 'pos'
	 * due
	 * // to the rows-, columns- and diagonal restrictions
